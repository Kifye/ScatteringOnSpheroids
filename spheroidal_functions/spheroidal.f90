...
contains
    ...
    subroutine calculate(this)
        ...
        !write(*,*) 's1exp = ', this%s1_exp
        !write(*,*) 's1dexp = ', this%s1d_exp
        ...
        this%legendre = 0
        do i = 1, this%lnum
           ! write(*,*) 'n = ', i, 'enr = ', enr(i, 1:5)
            this%legendre(i, mod(abs(i + 1), 2)) = 1
        ...
        !		write(*,*) 'r3:', this%r3(1:5)
        !		write(*,*) 'r1d:', this%r1d(1:5)
        !		write(*,*) 'start s1'
        !		write(*,*) 's1:', this%s1(1:10,1)
        !		write(*,*) 's1d:', this%s1d(1:10,1)
        !		write(*,*) 'end s1'
        !		write(*,*) 's1_exp:', this%s1_exp(1:10,1)
        !  write(*,*) 'legendre:', this%legendre(1:5, 0:5)
        !do i = 1, this%lnum
        !    write(*,*) 'legendre = ', this%legendre(i, :30)
        !end do
        !write(*,*)
